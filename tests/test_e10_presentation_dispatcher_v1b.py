...
E040_S1_WORLD_STAGE_SCRIPT_SRC = "/js/e9/world_stage.js?v=20260828e040s1"
...
def test_b1_index_html_changes_are_script_loading_only():
    ...
    assert E040_S1_WORLD_STAGE_SCRIPT_SRC in current_srcs
    ...
    normalized_current_srcs = [
        ...
        else BASE_WORLD_STAGE_SCRIPT_SRC if src == E040_S1_WORLD_STAGE_SCRIPT_SRC
