...
# The original default remains byte-compatible for existing callers/tests.
# New server-judged practice callers opt into this additive tuple explicitly.
PRACTICE_TRUSTED_SOURCE_PREFIX = "practice:v1:"
SERVER_TRUSTED_REVIEW_SOURCE_PREFIXES = (
    *TRUSTED_REVIEW_SOURCE_PREFIXES,
    PRACTICE_TRUSTED_SOURCE_PREFIX,
)
