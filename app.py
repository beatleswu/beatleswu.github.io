...
def admin_shadow_dashboard_recent():
    try:
        ...
        limit = 200
    return jsonify(recent_shadow_dashboard_data(limit=limit))
...
TITLE_ACHIEVEMENTS = {
    ...
    'title_foxwit':       (lambda m: m['challenge_wins']   >= 25,   '每日挑戰累積勝 25 場'),
...
@admin_required
def admin_shadow_dashboard_page(): return _serve_live_static_or_baked('shadow_dashboard.html')
