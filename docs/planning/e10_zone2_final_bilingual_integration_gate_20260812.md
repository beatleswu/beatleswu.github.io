...
- Script: `OWNER_DIALOGUE_V3` (Owner-approved bilingual dialogue)
...
- Herder zh-TW: Brb, `BrbEfHMQu0fyclQR7lfh`.
- Herder en: Ali - Everyday British (London) Male clean retake,
...
- Package: 53 exact-byte files, including 36 Owner-locked V3 bilingual dialogue files.
